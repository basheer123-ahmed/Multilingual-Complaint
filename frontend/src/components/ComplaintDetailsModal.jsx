            ...
            <div className="flex-1 p-8 md:p-10 overflow-y-auto no-scrollbar flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-3 bg-slate-50 p-6 rounded-[1.5rem] border border-slate-100 shadow-inner group">
                <div className="flex items-center gap-2">
                   ...
                   <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Tactical Brief</span>
                </div>
                <p className="text-base text-slate-800 font-bold leading-relaxed uppercase tracking-tight group-hover:text-slate-900 transition-colors">{complaint.description}</p>
              </div>
